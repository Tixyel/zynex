export type Session$AnyConfig =
  | Session$IntConfig
  | Session$StringConfig
  | Session$DateConfig
  | Session$ArrayConfig
  | Session$RecentConfig
  | undefined

export type Session$AvailableCategory = Record<
  string,
  Session$AnyConfig | Record<string, Session$AnyConfig | undefined> | undefined
>
